...
#index reference genome
echo "starting bwa index\n"
bwa index -p fcmgenome1 -a bwtsw $DIRfcmgenome_v1.fasta
echo "completed bwa index\n"
...
module load app/BUSCO/3.0

echo "starting BUSCO\n"
run_BUSCO.py -i $DIR/fcmgenome_v2.fasta -m genome -l $REFDIR/lepidoptera_odb10 -o fcmgenome_v2_Busco
